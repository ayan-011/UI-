 ...
 return(
     <div className=' w-full md:h-screen h-fit md:py-0 py-5 items-center flex md:flex-row flex-col md:gap-0 '>
        ...
        <div className='   flex flex-col  md:p-2 p-4 mt-16'>
            <p className="heading md:text-3xl text-4xl  md:font-bold  text-start "> <span className="font-light md:font-base">Completely</span> decentralized.</p>
            <p className='md:mt-8 md:text-lg   tracking-tight '>No central coordinator. No central point of failure. Your node, your rules, your sats, your privacy. Made possible by the market.</p>
        </div>
        </div>
...
function Third() {
 return(
    <div className=' w-full md:h-screen h-fit md:py-0 py-5 items-center flex md:flex-row flex-col md:gap-0 mb-10'>
        <div className='md:w-1/2  md:h-full h-1/3  bg-red-90  flex md:items-center md:px-28 items-end '>
        <div className='   flex flex-col gap-6 md:p-2 p-4 mt-16'>
            <p className="heading md:text-3xl text-4xl   font-semibold md:text-center text-start "> <span className="font-light">Completely</span> decentralized.</p>
            <p className='md:mt-8 md:text-lg   tracking-tight '>No central coordinator. No central point of failure. Your node, your rules, your sats, your privacy. Made possible by the market.</p>
        </div>
        </div>
        <div className='md:w-1/2 md:h-full h-1/2 bg-zinc-30 flex md:items-center items-start justify-center'>
